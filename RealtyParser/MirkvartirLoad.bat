rem sqlite3 RealtyParser.sqlite3 < MirkvartirAction.sql
rem sqlite3 RealtyParser.sqlite3 < MirkvartirRubric.sql
rem sqlite3 RealtyParser.sqlite3 < MirkvartirActionMapping.sql
